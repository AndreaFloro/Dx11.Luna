...
HillsDemoApp::HillsDemoApp(HINSTANCE hInstance)
...
void HillsDemoApp::UpdateScene(float dt)
{
...
void HillsDemoApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void HillsDemoApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void HillsDemoApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void HillsDemoApp::BuildGeometryBuffers()
{
...
void HillsDemoApp::BuildVertexLayout()
{
...
float HillsDemoApp::GetHeight(float x, float z) const
{
