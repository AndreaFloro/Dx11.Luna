...
bool BlendApp::Init()
{
	...
	ID3D11Resource* grassResource = nullptr;
	ID3D11Resource* wavesResource = nullptr;
	ID3D11Resource* fenceResource = nullptr;
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures/grass.dds", &grassResource, &mGrassMapSRV));
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures/water2.dds", &wavesResource, &mWavesMapSRV));
	HR(DirectX::CreateDDSTextureFromFile(md3dDevice, L"Textures/WireFence.dds", &fenceResource, &mBoxMapSRV));

	ReleaseCOM(grassResource); // view saves reference
	ReleaseCOM(wavesResource); // view saves reference
	ReleaseCOM(fenceResource); // view saves reference
